            ...
            <ul className="flex gap-x-2">
                {
                    isAuthenticated ? (
                        <>
                            ...
                            <li>
                                <Link to='/add-product' className='bg-zinc-500 rounded-sm'>Agregar Producto
                                    <IoAddCircle size={30} />
                                </Link>
                            </li>
                            <li>
                                <Link to='/products' className='bg-zinc-500 rounded-sm'>Editar Producto
                                    <IoAddCircle size={30} />

                                </Link>
                            </li>
                            <li>
                                <Link to='/' onClick={() => { logout() }} className='bg-zinc-500 rounded-sm'>LogOut
                                    <IoLogOut size={30} />
                                </Link>
                            </li>
                        </>
                        ...
                        <>
                            <li>
                                <Link to='/login' className='bg-zinc-500  rounded-sm'>
                                    Login<IoLogIn size={30} />
                                </Link>
                            </li>
                            <li>
                                <Link to='/register' className="bg-zinc-500  rounded-sm">
                                    Register<IoPersonAdd size={30} />
                                </Link>
                            </li>
                        </>
                    )
